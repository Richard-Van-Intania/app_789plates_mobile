...
final autoSignInProvider =
    FutureProvider<UnwrapResponse<Authentication>>.internal(
  autoSignIn,
...
/// See also [SignIn].
@ProviderFor(SignIn)
final signInProvider = AutoDisposeAsyncNotifierProvider<SignIn,
...
final renewTokenProvider = AutoDisposeAsyncNotifierProvider<RenewToken,
    UnwrapResponse<Authentication>>.internal(
  RenewToken.new,
  name: r'renewTokenProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$renewTokenHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
